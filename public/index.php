...
$router->get('/admin', [AdminController::class, 'index'], ['role:admin']);
$router->get('/admin/users', [AdminController::class, 'users'], ['role:admin']);
$router->get('/admin/users/create', [AdminController::class, 'userCreate'], ['role:admin']);
$router->post('/admin/users/store', [AdminController::class, 'userStore'], ['role:admin']);
$router->get('/admin/users/edit', [AdminController::class, 'userEdit'], ['role:admin']);
$router->post('/admin/users/update', [AdminController::class, 'userUpdate'], ['role:admin']);
$router->get('/admin/users/delete', [AdminController::class, 'userDelete'], ['role:admin']);
